...
const base =
  "inline-block rounded-full font-body text-[0.88rem] font-semibold uppercase tracking-[0.08em] px-[1.9em] py-[0.78em] transition-all duration-200 hover:-translate-y-0.5 text-center";
